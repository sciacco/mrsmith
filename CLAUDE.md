...
## Temp files
- Write all temporary files (screenshots, scratch outputs, intermediate artifacts) under `artifacts/claude/` at the repo root. Never use `/tmp/claude/` or other paths. The directory is gitignored.
