...
export function App() {
  ...
  if (accessState !== 'allowed') {
    return (
      <AppShell appName="Energia in DC" userName={user?.name} onLogout={logout} support={auth}>
        <AppShell.Content>
  ...
  return (
    <AppShell appName="Energia in DC" userName={user?.name ?? 'John Doe'} onLogout={logout} support={auth}>
      <AppShell.Nav>
        <Nav />
      </AppShell.Nav>
      <AppShell.Content>
