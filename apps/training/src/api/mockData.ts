  ...
  return [
    {
      ...
      member_count: 3,
      members: [
        { id: 'employee-ada', name: 'Verdi Ada', email: 'ada.verdi@cdlan.it', team_code: 'CLOUD', team_name: 'Cloud Operations' },
        { id: 'employee-marco', name: 'Rossi Marco', email: 'marco.rossi@cdlan.it', team_code: 'APPLICATIONS', team_name: 'Applications' },
        { id: 'employee-marta', name: 'Conti Marta', email: 'marta.conti@cdlan.it', team_code: 'APPLICATIONS', team_name: 'Applications' },
      ],
    ...
    },
    {
      ...
      members: [
        { id: 'employee-ada', name: 'Verdi Ada', email: 'ada.verdi@cdlan.it', team_code: 'CLOUD', team_name: 'Cloud Operations' },
        { id: 'employee-laura', name: 'Bianchi Laura', email: 'laura.bianchi@cdlan.it', team_code: 'CLOUD', team_name: 'Cloud Operations' },
      ],
      used_by: [],
    },
  ];
    ...
    masterData: isPeopleAdmin
      ? {
          ...
          certifications: [
            ...
            { id: 'cert-cka', code: 'CKA', name: 'Certified Kubernetes Administrator', issuerVendorId: 'vendor-linux', issuerVendorName: 'Linux Foundation', skillAreaId: 'skill-kubernetes', skillAreaLabel: 'Kubernetes', typicalValidityMonths: 36, active: true },
            { id: 'cert-terraform', code: 'TF-A', name: 'Terraform Associate', issuerVendorId: 'vendor-hashicorp', issuerVendorName: 'HashiCorp', skillAreaId: 'skill-iac', skillAreaLabel: 'Infrastructure as Code', active: true },
          ],
          plans: [
          ...
          mandatoryRules: [
            { id: 'rule-security', courseId: 'course-2', courseTitle: 'Sicurezza applicativa OWASP', teamId: 'team-app', teamLabel: 'Applications', roleFilter: 'developer', active: true },
          ],
        }
      : undefined,
  };
