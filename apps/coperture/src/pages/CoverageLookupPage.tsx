...
function ProgressRail({ step }: { step: 0 | 1 | 2 | 3 | 4 }) {
  const labels = ['Provincia', 'Comune', 'Indirizzo', 'Numero civico'];
  return (
      ...
      {!collapsed && (
        <div className={styles.searchArea}>
          ...
          <div className={styles.toolbar}>
            ...
            <div className={`${styles.field} ${stateId === null ? styles.selectDisabled : ''}`}>
              <SingleSelect
            ...
            <div className={`${styles.field} ${cityId === null ? styles.selectDisabled : ''}`}>
              <SingleSelect
            ...
            <div className={`${styles.field} ${addressId === null ? styles.selectDisabled : ''}`}>
              <SingleSelect
