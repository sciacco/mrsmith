...
const SECTIONS = [
  ...
  { id: 'registro', label: 'Registro azienda' },
...
function CompanyRegistrySection({ companyKey, vatCode, companyName }: { companyKey: string; vatCode: string; companyName?: string }) {
      ...
      <div className={styles.dossierLayout}>
        ...
        <div className={styles.body}>
          ...
          <CompanyRegistrySection
            companyKey={dossier.vatCode}
            vatCode={dossier.vatCode}
            companyName={itf.companyDetails?.companyName}
          />
