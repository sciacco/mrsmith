...
export function App() {
  ...
  if (accessState !== 'allowed') {
    return (
      <AppShell appName="Compliance" userName={user?.name} onLogout={logout} support={auth}>
        <AppShell.Content>
  ...
  return (
    <AppShell appName="Compliance" userName={user?.name ?? 'John Doe'} onLogout={logout} support={auth}>
      <AppShell.Nav>
