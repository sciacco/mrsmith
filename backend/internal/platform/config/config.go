...
type Config struct {
	...
	// evidence). Firecrawl-compatible /v1/scrape. Empty => disabled.
	// ScrapeAPIKey is sent as a Bearer token when set (managed services like
	// fastcrw.com require it; self-hosted Firecrawl does not).
