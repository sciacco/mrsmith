...
var db = &store{
	...
	budgets: map[int64]*budgetData{
		11: {name: "Accessi", year: 2026, limit: "44154.00", current: "44154.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 11, CostCenter: "Delivery TLC", Current: "44154.00", Enabled: true, Limit: "44154.00"},
		}},
		16: {name: "Associazioni/Abbonamenti", year: 2026, limit: "24000.00", current: "5860.76", userAllocations: []userBudgetAllocation{}, ccAllocations: []costCenterBudgetAllocation{}},
		6: {name: "Automezzi", year: 2026, limit: "20833.69", current: "1833.69", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 6, CostCenter: "AI Process", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 6, CostCenter: "Board", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 6, CostCenter: "Compliance", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 6, CostCenter: "Data Center", Current: "0.00", Enabled: true, Limit: "2000.00"},
			{BudgetID: 6, CostCenter: "Office - TR", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 6, CostCenter: "Delivery TLC", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 6, CostCenter: "Delivery MS", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 6, CostCenter: "CustXP", Current: "0.00", Enabled: true, Limit: "7000.00"},
			{BudgetID: 6, CostCenter: "People", Current: "1833.69", Enabled: true, Limit: "1833.69"},
		}},
		24: {name: "Budget [PER TEST]", year: 2026, limit: "22300.00", current: "22300.00", userAllocations: []userBudgetAllocation{}, ccAllocations: []costCenterBudgetAllocation{}},
		17: {name: "CEO", year: 2026, limit: "100000.00", current: "0.00", userAllocations: []userBudgetAllocation{}, ccAllocations: []costCenterBudgetAllocation{}},
		3: {name: "Consulenza", year: 2026, limit: "95000.00", current: "10963.88", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 3, CostCenter: "Amministrazione", Current: "0.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 3, CostCenter: "People", Current: "4662.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 3, CostCenter: "MeA", Current: "0.00", Enabled: true, Limit: "50000.00"},
			{BudgetID: 3, CostCenter: "Board", Current: "4130.88", Enabled: true, Limit: "20000.00"},
			{BudgetID: 3, CostCenter: "Compliance", Current: "2171.00", Enabled: true, Limit: "5000.00"},
		}},
		5: {name: "Eventi esterni", year: 2026, limit: "70000.00", current: "750.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 5, CostCenter: "Board", Current: "0.00", Enabled: true, Limit: "20000.00"},
			{BudgetID: 5, CostCenter: "Communication", Current: "750.00", Enabled: true, Limit: "50000.00"},
		}},
		10: {name: "Eventi interni", year: 2026, limit: "27000.00", current: "5152.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 10, CostCenter: "Communication", Current: "2460.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 10, CostCenter: "Office - MI", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 10, CostCenter: "Office - TR", Current: "0.00", Enabled: true, Limit: "2000.00"},
			{BudgetID: 10, CostCenter: "People", Current: "2692.00", Enabled: true, Limit: "10000.00"},
		}},
		18: {name: "Fonia", year: 2026, limit: "20000.00", current: "0.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 18, CostCenter: "Delivery CLOUD", Current: "0.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 18, CostCenter: "Delivery MS", Current: "0.00", Enabled: true, Limit: "10000.00"},
		}},
		8: {name: "Formazione", year: 2026, limit: "46000.00", current: "1515.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 8, CostCenter: "Applications", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 8, CostCenter: "Data Center", Current: "0.00", Enabled: true, Limit: "3000.00"},
			{BudgetID: 8, CostCenter: "Amministrazione", Current: "0.00", Enabled: true, Limit: "3000.00"},
			{BudgetID: 8, CostCenter: "Communication", Current: "0.00", Enabled: true, Limit: "3000.00"},
			{BudgetID: 8, CostCenter: "Compliance", Current: "0.00", Enabled: true, Limit: "2000.00"},
			{BudgetID: 8, CostCenter: "Office - MI", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 8, CostCenter: "Office - TR", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 8, CostCenter: "Delivery CLOUD", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 8, CostCenter: "Delivery MS", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 8, CostCenter: "Delivery TLC", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 8, CostCenter: "CustXP", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 8, CostCenter: "Assurance", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 8, CostCenter: "People", Current: "1515.00", Enabled: true, Limit: "3000.00"},
		}},
		22: {name: "Hardware", year: 2026, limit: "162398.50", current: "36623.98", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 22, CostCenter: "Delivery MS", Current: "225.48", Enabled: true, Limit: "25000.00"},
			{BudgetID: 22, CostCenter: "Infrastruttura SYS-NET", Current: "0.00", Enabled: true, Limit: "50000.00"},
			{BudgetID: 22, CostCenter: "Delivery TLC", Current: "0.00", Enabled: true, Limit: "25000.00"},
			{BudgetID: 22, CostCenter: "AI Process", Current: "0.00", Enabled: true, Limit: "26000.00"},
			{BudgetID: 22, CostCenter: "Delivery CLOUD", Current: "36398.50", Enabled: true, Limit: "36398.50"},
		}},
		21: {name: "Manutenzioni", year: 2026, limit: "324060.00", current: "306060.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 21, CostCenter: "Office - MI", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 21, CostCenter: "Office - TR", Current: "0.00", Enabled: true, Limit: "3000.00"},
			{BudgetID: 21, CostCenter: "Infrastruttura SYS-NET", Current: "0.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 21, CostCenter: "Data Center", Current: "306060.00", Enabled: true, Limit: "306060.00"},
		}},
		4: {name: "Merci/Attrezzature", year: 2026, limit: "102794.91", current: "17889.29", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 4, CostCenter: "Delivery CLOUD", Current: "0.00", Enabled: true, Limit: "20000.00"},
			{BudgetID: 4, CostCenter: "Delivery MS", Current: "1765.00", Enabled: true, Limit: "20000.00"},
			{BudgetID: 4, CostCenter: "Amministrazione", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 4, CostCenter: "Applications", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 4, CostCenter: "Office - MI", Current: "674.03", Enabled: true, Limit: "5000.00"},
			{BudgetID: 4, CostCenter: "Communication", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 4, CostCenter: "Compliance", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 4, CostCenter: "CustXP", Current: "11794.91", Enabled: true, Limit: "11794.91"},
			{BudgetID: 4, CostCenter: "Delivery TLC", Current: "404.91", Enabled: true, Limit: "20000.00"},
			{BudgetID: 4, CostCenter: "Data Center", Current: "3196.10", Enabled: true, Limit: "15000.00"},
			{BudgetID: 4, CostCenter: "Office - TR", Current: "54.34", Enabled: true, Limit: "3000.00"},
		}},
		23: {name: "Pubblicità", year: 2026, limit: "25000.00", current: "1640.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 23, CostCenter: "Communication", Current: "1640.00", Enabled: true, Limit: "25000.00"},
		}},
		15: {name: "Servizi Generali", year: 2026, limit: "20000.00", current: "0.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 15, CostCenter: "Amministrazione", Current: "0.00", Enabled: true, Limit: "20000.00"},
		}},
		7: {name: "Servizi Infrastruttura", year: 2026, limit: "25000.00", current: "16399.71", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 7, CostCenter: "Infrastruttura SYS-NET", Current: "16399.71", Enabled: true, Limit: "25000.00"},
		}},
		14: {name: "Software (per rivendita)", year: 2026, limit: "120000.00", current: "5891.71", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 14, CostCenter: "Delivery MS", Current: "44.89", Enabled: true, Limit: "60000.00"},
			{BudgetID: 14, CostCenter: "Delivery CLOUD", Current: "5846.82", Enabled: true, Limit: "60000.00"},
		}},
		13: {name: "Software Uso Interno", year: 2026, limit: "57000.00", current: "3992.42", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 13, CostCenter: "Communication", Current: "0.00", Enabled: true, Limit: "2000.00"},
			{BudgetID: 13, CostCenter: "Data Center", Current: "0.00", Enabled: true, Limit: "3000.00"},
			{BudgetID: 13, CostCenter: "Compliance", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 13, CostCenter: "Infrastruttura SYS-NET", Current: "0.00", Enabled: true, Limit: "20000.00"},
			{BudgetID: 13, CostCenter: "Board", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 13, CostCenter: "People", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 13, CostCenter: "AI Process", Current: "0.00", Enabled: true, Limit: "11000.00"},
			{BudgetID: 13, CostCenter: "Amministrazione", Current: "3159.92", Enabled: true, Limit: "5000.00"},
			{BudgetID: 13, CostCenter: "Applications", Current: "832.50", Enabled: true, Limit: "5000.00"},
		}},
		20: {name: "Tasse/Imposte", year: 2026, limit: "10000.00", current: "0.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 20, CostCenter: "Amministrazione", Current: "0.00", Enabled: true, Limit: "10000.00"},
		}},
		25: {name: "Transito internet", year: 2026, limit: "17600.00", current: "10000.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 25, CostCenter: "Delivery CLOUD", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 25, CostCenter: "Delivery TLC", Current: "7600.00", Enabled: true, Limit: "7600.00"},
			{BudgetID: 25, CostCenter: "Infrastruttura SYS-NET", Current: "2400.00", Enabled: true, Limit: "5000.00"},
		}},
		9: {name: "Trasferte", year: 2026, limit: "58000.00", current: "1822.92", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 9, CostCenter: "CustXP", Current: "0.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 9, CostCenter: "Delivery CLOUD", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 9, CostCenter: "Delivery MS", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 9, CostCenter: "Delivery TLC", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 9, CostCenter: "Applications", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 9, CostCenter: "Board", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 9, CostCenter: "Compliance", Current: "0.00", Enabled: true, Limit: "1000.00"},
			{BudgetID: 9, CostCenter: "Communication", Current: "0.00", Enabled: true, Limit: "3000.00"},
			{BudgetID: 9, CostCenter: "Office - TR", Current: "0.00", Enabled: true, Limit: "5000.00"},
			{BudgetID: 9, CostCenter: "MeA", Current: "0.00", Enabled: true, Limit: "10000.00"},
			{BudgetID: 9, CostCenter: "AI Process", Current: "0.00", Enabled: true, Limit: "6000.00"},
			{BudgetID: 9, CostCenter: "Office - MI", Current: "721.65", Enabled: true, Limit: "5000.00"},
			{BudgetID: 9, CostCenter: "People", Current: "777.27", Enabled: true, Limit: "2000.00"},
			{BudgetID: 9, CostCenter: "Data Center", Current: "324.00", Enabled: true, Limit: "3000.00"},
		}},
		19: {name: "Welfare", year: 2026, limit: "60000.00", current: "510.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
			{BudgetID: 19, CostCenter: "People", Current: "510.00", Enabled: true, Limit: "60000.00"},
		}},
		12: {name: "Xconnect", year: 2026, limit: "20000.00", current: "4430.00", userAllocations: nil, userAllocationsNil: true, ccAllocations: []costCenterBudgetAllocation{
