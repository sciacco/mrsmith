...
- Open questions: issue #81 tracks making the identity ours instead of the vendor's — adopting the existing keys as opaque internal ids and resolving new writes through a fiscal-identity conversion table, so a vendor change or renumbering cannot break continuity.
